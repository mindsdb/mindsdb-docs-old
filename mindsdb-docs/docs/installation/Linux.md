...
Install MindsDB on your Linux machine using an easy-to-install shell script.

!!! tip "Download the script"
    [MindsDB for Linux](https://mindsdb-installer.s3-us-west-2.amazonaws.com/mindsdb-installer/linux/MindsDB-Server-Latest-Setup.sh)
