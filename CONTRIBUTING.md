# Contributing to MindsDB's docs

We love to receive contributions from the community and hear your opinions! We want to make contributing to MindsDB's documentation as easily as it can be.
...
1. Fork the mindsdb-docs repository
...
We use GitHub issues to track bugs and features. Report them by opening a [new issue](https://github.com/mindsdb/mindsdb-docs/issues/new/choose) and fill out all of the required inputs.
